(function() {
	...
	function onLoadPositionFailed() {
		console.warn('navigator\'s geolocation is not available');
	...
	function getLocationFromIP() {
		...
		ajax('GET', url, req, function(res) {
			...
			if ('loc' in result) {
				...
				console.warn('Getting location by IP has failed.');
			}
		});
	}
	...
	function loadNearbyItems () {
		//var lon = -122.08;
    	//var lat = 37.38;  // hard code
        console.log('loadNearbyItemsssss');
		console.log(lat);
		console.log(lon);
     ...
     * user_id: 1111, visited: [a_list_of_item_ids] }
     */
    ...
    function addItem(itemList, item) {
        ...
        if (item.imageUrl) {
            ...
            li.appendChild($(
                'img', {
                    src: 'https://kaverisias.com/wp-content/uploads/2018/01/catalog-default-img'
                }))
        }
        // section
        var section = $('div', {});
